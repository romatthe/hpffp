...
We alread did this more or less in the previous exercise, but just for completions sake: module Strings where

addBang :: String -> String addBang x = x ++ "!"

takeFourth :: String -> String takeFourth x = [x !! 4]

lastWord :: String -> String lastWord x = last $ words x
...
rvrs :: String -> String rvrs x = awesome ~~+ " " +~~ is ~~+ " " +~~ curry where awesome = drop 9 x is = take 2 $ drop 6 x curry = take 5 x
